...
export const Home: React.FC = () => {
  ...
  return (
    <Layout>
          ...
          <div className="pt-10 sm:pt-12 md:pt-16 lg:pt-20 xl:pt-28">
            <div className="sm:text-center lg:text-left">
              ...
              <p className="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
                ...
                everyone know who they're buying for - all in one place.
              </p>
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="lg:text-center">
            <h2
              id="features-heading"
              className="text-base text-[#B91C1C] font-semibold tracking-wide uppercase"
            >
              Features
            </h2>
          ...
          <div className="mt-10">
            <dl className="space-y-10 md:space-y-0 md:grid md:grid-cols-2 md:gap-x-8 md:gap-y-10">
              ...
              <div className="relative">
                ...
                <dd className="mt-2 ml-16 text-base text-gray-500">
                  Keep your Secret Santa truly secret with our secure assignment
                  system.
                </dd>
              </div>
            </dl>
      ...
      {/* Final CTA Section */}
      <section className="bg-[#B91C1C] py-16" aria-labelledby="cta-heading">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
